...
public class NzbgetService : INzbgetService
{
    ...
    public NzbgetService(ILogger<INzbgetService> logger, IOptions<NzbgetServiceOptions> options)
    {
        ...
        this.options = options?.Value ?? new NzbgetServiceOptions();
        ...
        {
            var baseUrl = (this.options.UseHttps ? "https://" : "http://") + authString + this.options.Hostname + ":" + this.options.Port;
    ...
    public void setOptions(IOptions<NzbgetServiceOptions> optionsToSet)
    {
        ...
        var baseUrl = (options.UseHttps ? "https://" : "http://") + authString + options.Hostname + ":" +
                      options.Port;
    ...
    public List<NzbgetQueue> GetQueue()
    {
        ...
        return response?.Result ?? new List<NzbgetQueue>();
    }
    ...
    public List<NzbgetHistory> GetHistory()
    {
        ...
        return data?.Result ?? new List<NzbgetHistory>();
    }
